...
setup(
    name='adrfinder',
    version=find_version("adrfinder", "__init__.py"),
    ...
    zip_safe=False,
    entry_points={"console_scripts": ["adrfinder=adrfinder:main"]},
    author='chuckmac',
    url='https://chuckmacdev.com/adrfinder',
    scripts=['adrfinder.py'],
    packages=['adrfinder'],

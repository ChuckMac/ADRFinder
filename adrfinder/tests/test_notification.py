...
import logging
from adrfinder.notification import default_notification_body, default_notification_title
...
def test_check_notification(client, live_server):
    ...
    res = client.post(
        ...
        data={"notification_urls": notification_url,
              "notification_title": "New ADRFinder Notification - {watch_url}",
    ...
    # https://github.com/chuckmac/adrfinder/discussions/192
    os.unlink("test-datastore/notification.txt")
